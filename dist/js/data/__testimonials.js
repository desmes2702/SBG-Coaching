export const testimonials = [
	{
	  ...
	  age: null,
	  photo: "img/testimonial__labeyeLallemend.png",
	  featured: true,
	  text: [
	...
	{
	  name: "Christian",
	  photo: "img/testimonial__christian.png",
	  text: [
	...
	{
	  name: "Justin",
	  photo: "img/testimonial__justin.png",
	  text: [
	...
	},
	{
	  ...
	  photo: "img/testimonial__plenevauxNijs.png",
	  text: [
	...
	{
	  name: "UDH SPRL",
	  photo: "img/testimonial__udhSprl.png",
	  text: [
	...
	},
	{
	  ...
	  photo: "img/testimonial__ducheneSa.png",
	  text: [
	...
	{
	  name: "Alice",
	  photo: "img/testimonial__alice.png",
	  text: [
